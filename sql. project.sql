...
-- Q10: Find each year and the average number of content releases in India on Netflix.
...
WHERE
  ...
  -- Q14: Categorize the content based on the presence of the keywords 'kill' and 'violence'
